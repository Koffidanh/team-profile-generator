...
<div class="col-md-3">
    <div class="card">
        ...
        <div class="cardFooter">
            ...
            <h4>Email: ${data.managerEmail}</h4>
            <h4>Office #: ${data.managerOfficeNumber}</h4>
        </div>
...
<div class="col-md-3">
    <div class="card">
        ...
        <div class="cardFooter">
            ...
            <h4>Email: ${data.engineerEmail}</h4>
            <h4>GitHub:  <a href="https://github.com/${data.engineerGitHub}">${data.engineerGitHub}</a></h4>
        </div>
    ...
    <div class="card">
        ...
        <div class="cardFooter">
            ...
            <h4>Email: ${data.InternEmail}</h4>
            <h4>Office #: ${data.internSchool}</h4>
        </div>
