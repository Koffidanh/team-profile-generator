...
<h1 class="display-3">${teamMemberArray[0]}</h1>
</div>
<div class="row">
<div class="col-md-4">
    <div class="card">
        <div class="cardHeader">
            ...
            <div class="row">
                <div class="col-md-6">
                    <i class='${teamMemberArray.icon}' style='font-size:30px;color:red'></i>
                </div>
                <div class="col-md-6">
        ...
        <div class="cardFooter">
            ...
            <h4>${teamMemberArrayChange} #: ${`teamMemberArray${i}["teamMemberArrayChange"]`}</h4>
        </div>
    </div>
</div>
