...
<div class="col-md-4"></div>
    ...
    <div class="card">
        <div class="cardHeader">
            <h2>${teamMemberArray[9]["name"]}</h2>
            <div class="row">
                <div class="col-md-6">
                <i class='fas fa-graduation-cap' style='font-size:48px;color:red'></i>
                </div>
                <div class="col-md-6">
                    <h4>${teamMemberArray[8]["role"]}</h4>
                </div>
            </div>

        </div>
        <div class="cardFooter">
            <h4>ID: ${teamMemberArray[9]["id"]}</h4>
            <h4>Email: <a href = "mailto: ${teamMemberArray[9]["email"]}">${teamMemberArray[9]["email"]}</a></h4>
            <h4>School name: ${teamMemberArray[9]["schoolName"]}</h4>
        </div>
